...
BASE_DEFENSE_PLACEMENT = {
    -- guns and SHORAD need open sky: the infield first, tight to aprons/parking after.
    -- No building anchors — airfield buildings can stand in forest.
    aaa = {
        role = "aaa",
        anchors = { infield = { 6, 0, 40 }, apron = { 2, 40, 100 }, parking = { 1, 40, 100 },
                    runway_side = { 2, 0, 60 } },
        ring = { 600, 1500 }, units = { 2, 4 }, spread = 60, mixed_types = false,
    },
    shorad = {
        role = "shorad",
        anchors = { infield = { 6, 0, 40 }, apron = { 2, 40, 100 }, parking = { 1, 40, 100 },
                    runway_side = { 2, 0, 60 } },
        ring = { 500, 1500 }, units = { 1, 2 }, spread = 80, mixed_types = false,
    },
    ...
    manpads_team = {
        ...
        ring = { 800, 2000 }, units = { 2, 3 }, spread = 30, mixed_types = false,
    },
    security_infantry = {
        role = "infantry",
        anchors = { building = { 3, 30, 200 }, parking = { 2, 40, 200 }, apron = { 1, 40, 200 },
                    runway_side = { 1, 30, 200 } },
        ring = { 400, 1200 }, units = { 4, 6 }, spread = 40, mixed_types = true,
    },
}
